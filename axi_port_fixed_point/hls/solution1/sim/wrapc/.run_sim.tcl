...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mem_streaming.autotvin.dat"
	set constFileTvOut       "mem_streaming.autotvout.dat"
	set constFileHdlTvIn     "mem_streaming.autohdltvin.dat"
	set constFileHdlTvOut    "mem_streaming.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
