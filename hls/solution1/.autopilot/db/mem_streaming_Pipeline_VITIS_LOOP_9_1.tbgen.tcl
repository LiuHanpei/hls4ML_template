set moduleName mem_streaming_Pipeline_VITIS_LOOP_9_1
set isTopModule 0
...
set C_modelName {mem_streaming_Pipeline_VITIS_LOOP_9_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_r int 256 regular {axi_master 0}  }
	{ sext_ln9 int 59 regular  }
	{ data_buf int 16 regular {array 10 { 0 0 } 0 1 }  }
	{ data_buf_1 int 16 regular {array 10 { 0 0 } 0 1 }  }
	{ data_buf_2 int 16 regular {array 10 { 0 0 } 0 1 }  }
	{ data_buf_3 int 16 regular {array 10 { 0 0 } 0 1 }  }
	{ data_buf_4 int 16 regular {array 10 { 0 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_r", "interface" : "axi_master", "bitwidth" : 256, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "data_in","offset": { "type": "dynamic","port_name": "data_in","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln9", "interface" : "wire", "bitwidth" : 59, "direction" : "READONLY"} , 
 	{ "Name" : "data_buf", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_buf_1", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_buf_2", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_buf_3", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "data_buf_4", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ m_axi_in_r_WDATA sc_out sc_lv 256 signal 0 } 
	{ m_axi_in_r_WSTRB sc_out sc_lv 32 signal 0 } 
	...
	{ m_axi_in_r_RDATA sc_in sc_lv 256 signal 0 } 
	...
	{ data_buf_1_we1 sc_out sc_logic 1 signal 3 } 
	{ data_buf_1_d1 sc_out sc_lv 16 signal 3 } 
	{ data_buf_2_address0 sc_out sc_lv 4 signal 4 } 
	{ data_buf_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ data_buf_2_we0 sc_out sc_logic 1 signal 4 } 
	{ data_buf_2_d0 sc_out sc_lv 16 signal 4 } 
	{ data_buf_2_address1 sc_out sc_lv 4 signal 4 } 
	{ data_buf_2_ce1 sc_out sc_logic 1 signal 4 } 
	{ data_buf_2_we1 sc_out sc_logic 1 signal 4 } 
	{ data_buf_2_d1 sc_out sc_lv 16 signal 4 } 
	{ data_buf_3_address0 sc_out sc_lv 4 signal 5 } 
	{ data_buf_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ data_buf_3_we0 sc_out sc_logic 1 signal 5 } 
	{ data_buf_3_d0 sc_out sc_lv 16 signal 5 } 
	{ data_buf_3_address1 sc_out sc_lv 4 signal 5 } 
	{ data_buf_3_ce1 sc_out sc_logic 1 signal 5 } 
	{ data_buf_3_we1 sc_out sc_logic 1 signal 5 } 
	{ data_buf_3_d1 sc_out sc_lv 16 signal 5 } 
	{ data_buf_4_address0 sc_out sc_lv 4 signal 6 } 
	{ data_buf_4_ce0 sc_out sc_logic 1 signal 6 } 
	{ data_buf_4_we0 sc_out sc_logic 1 signal 6 } 
	{ data_buf_4_d0 sc_out sc_lv 16 signal 6 } 
	{ data_buf_4_address1 sc_out sc_lv 4 signal 6 } 
	{ data_buf_4_ce1 sc_out sc_logic 1 signal 6 } 
	{ data_buf_4_we1 sc_out sc_logic 1 signal 6 } 
	{ data_buf_4_d1 sc_out sc_lv 16 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln9", "direction": "in", "datatype": "sc_lv", "bitwidth":59, "type": "signal", "bundle":{"name": "sext_ln9", "role": "default" }} , 
 	...
 	{ "name": "data_buf_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_buf", "role": "d1" }} , 
 	...
 	{ "name": "data_buf_1_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_buf_1", "role": "we1" }} , 
 	{ "name": "data_buf_1_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_buf_1", "role": "d1" }} , 
 	...
 	{ "name": "data_buf_2_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_buf_2", "role": "we1" }} , 
 	{ "name": "data_buf_2_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_buf_2", "role": "d1" }} , 
 	...
 	{ "name": "data_buf_3_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_buf_3", "role": "we1" }} , 
 	{ "name": "data_buf_3_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_buf_3", "role": "d1" }} , 
 	...
 	{ "name": "data_buf_4_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "data_buf_4", "role": "we1" }} , 
 	{ "name": "data_buf_4_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "data_buf_4", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	 { m_axi {  { m_axi_in_r_AWVALID VALID 1 1 }  { m_axi_in_r_AWREADY READY 0 1 }  { m_axi_in_r_AWADDR ADDR 1 64 }  { m_axi_in_r_AWID ID 1 1 }  { m_axi_in_r_AWLEN SIZE 1 32 }  { m_axi_in_r_AWSIZE BURST 1 3 }  { m_axi_in_r_AWBURST LOCK 1 2 }  { m_axi_in_r_AWLOCK CACHE 1 2 }  { m_axi_in_r_AWCACHE PROT 1 4 }  { m_axi_in_r_AWPROT QOS 1 3 }  { m_axi_in_r_AWQOS REGION 1 4 }  { m_axi_in_r_AWREGION USER 1 4 }  { m_axi_in_r_AWUSER DATA 1 1 }  { m_axi_in_r_WVALID VALID 1 1 }  { m_axi_in_r_WREADY READY 0 1 }  { m_axi_in_r_WDATA FIFONUM 1 256 }  { m_axi_in_r_WSTRB STRB 1 32 }  { m_axi_in_r_WLAST LAST 1 1 }  { m_axi_in_r_WID ID 1 1 }  { m_axi_in_r_WUSER DATA 1 1 }  { m_axi_in_r_ARVALID VALID 1 1 }  { m_axi_in_r_ARREADY READY 0 1 }  { m_axi_in_r_ARADDR ADDR 1 64 }  { m_axi_in_r_ARID ID 1 1 }  { m_axi_in_r_ARLEN SIZE 1 32 }  { m_axi_in_r_ARSIZE BURST 1 3 }  { m_axi_in_r_ARBURST LOCK 1 2 }  { m_axi_in_r_ARLOCK CACHE 1 2 }  { m_axi_in_r_ARCACHE PROT 1 4 }  { m_axi_in_r_ARPROT QOS 1 3 }  { m_axi_in_r_ARQOS REGION 1 4 }  { m_axi_in_r_ARREGION USER 1 4 }  { m_axi_in_r_ARUSER DATA 1 1 }  { m_axi_in_r_RVALID VALID 0 1 }  { m_axi_in_r_RREADY READY 1 1 }  { m_axi_in_r_RDATA FIFONUM 0 256 }  { m_axi_in_r_RLAST LAST 0 1 }  { m_axi_in_r_RID ID 0 1 }  { m_axi_in_r_RFIFONUM LEN 0 9 }  { m_axi_in_r_RUSER DATA 0 1 }  { m_axi_in_r_RRESP RESP 0 2 }  { m_axi_in_r_BVALID VALID 0 1 }  { m_axi_in_r_BREADY READY 1 1 }  { m_axi_in_r_BRESP RESP 0 2 }  { m_axi_in_r_BID ID 0 1 }  { m_axi_in_r_BUSER DATA 0 1 } } }
	sext_ln9 { ap_none {  { sext_ln9 in_data 0 59 } } }
	data_buf { ap_memory {  { data_buf_address0 mem_address 1 4 }  { data_buf_ce0 mem_ce 1 1 }  { data_buf_we0 mem_we 1 1 }  { data_buf_d0 mem_din 1 16 }  { data_buf_address1 MemPortADDR2 1 4 }  { data_buf_ce1 MemPortCE2 1 1 }  { data_buf_we1 MemPortWE2 1 1 }  { data_buf_d1 MemPortDIN2 1 16 } } }
	data_buf_1 { ap_memory {  { data_buf_1_address0 mem_address 1 4 }  { data_buf_1_ce0 mem_ce 1 1 }  { data_buf_1_we0 mem_we 1 1 }  { data_buf_1_d0 mem_din 1 16 }  { data_buf_1_address1 MemPortADDR2 1 4 }  { data_buf_1_ce1 MemPortCE2 1 1 }  { data_buf_1_we1 MemPortWE2 1 1 }  { data_buf_1_d1 MemPortDIN2 1 16 } } }
	data_buf_2 { ap_memory {  { data_buf_2_address0 mem_address 1 4 }  { data_buf_2_ce0 mem_ce 1 1 }  { data_buf_2_we0 mem_we 1 1 }  { data_buf_2_d0 mem_din 1 16 }  { data_buf_2_address1 MemPortADDR2 1 4 }  { data_buf_2_ce1 MemPortCE2 1 1 }  { data_buf_2_we1 MemPortWE2 1 1 }  { data_buf_2_d1 MemPortDIN2 1 16 } } }
	data_buf_3 { ap_memory {  { data_buf_3_address0 mem_address 1 4 }  { data_buf_3_ce0 mem_ce 1 1 }  { data_buf_3_we0 mem_we 1 1 }  { data_buf_3_d0 mem_din 1 16 }  { data_buf_3_address1 MemPortADDR2 1 4 }  { data_buf_3_ce1 MemPortCE2 1 1 }  { data_buf_3_we1 MemPortWE2 1 1 }  { data_buf_3_d1 MemPortDIN2 1 16 } } }
	data_buf_4 { ap_memory {  { data_buf_4_address0 mem_address 1 4 }  { data_buf_4_ce0 mem_ce 1 1 }  { data_buf_4_we0 mem_we 1 1 }  { data_buf_4_d0 mem_din 1 16 }  { data_buf_4_address1 MemPortADDR2 1 4 }  { data_buf_4_ce1 MemPortCE2 1 1 }  { data_buf_4_we1 MemPortWE2 1 1 }  { data_buf_4_d1 MemPortDIN2 1 16 } } }
}
