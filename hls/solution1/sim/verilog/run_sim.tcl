...
if {[file isfile mem_streaming.autotvin.dat]} {
	file delete -force mem_streaming.autotvin.dat
}

if {[file isfile mem_streaming.autotvout.dat]} {
	file delete -force mem_streaming.autotvout.dat
}
