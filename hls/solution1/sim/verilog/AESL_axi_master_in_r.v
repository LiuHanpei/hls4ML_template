...
//------------------------Parameter----------------------
`define TV_IN_in_r "../tv/cdatafile/c.mem_streaming.autotvin_in_r.dat"
`define TV_OUT_in_r "../tv/rtldatafile/rtl.mem_streaming.autotvout_in_r.dat"
 parameter in_r_ADDR_BITWIDTH = 32'd 64;
 parameter in_r_AWUSER_BITWIDTH = 32'd 1;
 parameter in_r_DATA_BITWIDTH = 32'd 256;
...
parameter in_r_C_DATA_BITWIDTH = 32'd 256;
parameter in_r_transaction_depth = 32'd 5;
parameter in_r_mem_depth = 32'd 5;
...
reg    BRESP_tmp = 0;
reg    [in_r_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
...
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [in_r_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [in_r_DATA_BITWIDTH - 1 : 0] in_r_mem_0 [0: in_r_mem_depth - 1] = '{default : 'h0}; 
reg [in_r_DATA_BITWIDTH - 1 : 0] in_r_mem_1 [0: in_r_mem_depth - 1] = '{default : 'h0}; 
reg [in_r_DATA_BITWIDTH - 1 : 0] in_r_mem_2 [0: in_r_mem_depth - 1] = '{default : 'h0}; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_in_r_AWREADY & TRAN_in_r_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            ...
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_in_r_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_in_r_ARREADY & TRAN_in_r_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            ...
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_in_r_ARID; 
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > in_r_mem_depth) begin
                $display ("F:/vivado_projects/hls_4ML/axi_port_fixed_point/solution1/sim/verilog/AESL_axi_master_in_r.v: Write request address %d exceed AXI master in_r array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, in_r_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > in_r_mem_depth) begin
                $display ("F:/vivado_projects/hls_4ML/axi_port_fixed_point/solution1/sim/verilog/AESL_axi_master_in_r.v: Read request address %d exceed AXI master in_r array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, in_r_mem_depth); 
                $finish;
            end
...
initial begin : read_file_process 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      for(i = 0; i < in_r_transaction_depth; i = i + 1) begin 
          ...
          if (i%1 == 0) begin
              case(mem_page)
                  0 : in_r_mem_0[i/1] = mem_tmp;
                  1 : in_r_mem_1[i/1] = mem_tmp;
                  2 : in_r_mem_2[i/1] = mem_tmp;
